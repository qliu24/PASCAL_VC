...
def extractLayerFeat(category, extractor, scale_size=224, set_type='train'):
    ...
    file_cache_feat = os.path.join(Feat['cache_dir'], 'feat_{}_{}.pickle'.format(category, set_type))
