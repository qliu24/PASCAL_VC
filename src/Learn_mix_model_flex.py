...
def learn_mix_model_flex(categroy, magic_thh, K=4):
    ...
    savename = os.path.join(root_dir,'mix_model','mmodel_{}_K{}_notrain_flex.pickle'.format(category, K))
...
if __name__=='__main__':
    ...
    for ic,category in enumerate(all_categories):
        learn_mix_model_flex(category, thh_ls[ic])
